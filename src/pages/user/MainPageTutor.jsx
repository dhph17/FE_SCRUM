...
import Panel_Search_Tutor from "../../layouts/panel/Panel_Search_Tutor";
...
const MainPageTutor = () => {
  ...
  return (
    <Panel_Search_Tutor className="flex flex-col max-h-full">
        ...
        {currentPosts.map((tutor, index) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="flex flex-row justify-center items-center gap-[20rem] h-20 bg-[#002182] mt-5 rounded-[0.8rem]">
                <button className="bg-yellow-500 p-2 rounded-[0.5rem] font-semibold font-poppins w-[12vw]">
                  Đăng ký dạy
                </button>
                <button className="bg-yellow-500 p-2 rounded-[0.5rem] font-semibold font-poppins w-[12vw]">
                  Hủy đăng ký
