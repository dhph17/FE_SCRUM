...
import Img2 from "../../assets/image/medal.png"
    ...
    <Page>
      <div className="border-solid border-2 border-indigo-600 rounded-2xl mb-2">
        ...
        <div className="bg-blue-500 h-[55px] flex justify-center items-center gap-10 rounded-b-2xl">
            <button className="bg-yellow-500 p-2 rounded-2xl">Duyệt bài đăng</button>
            <button className="bg-yellow-500 p-2 rounded-2xl">Xóa bài đăng</button>
            <button className="bg-yellow-500 p-2 rounded-2xl">Danh sách gia sư đăng ký</button>
