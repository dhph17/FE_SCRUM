    ...
    return (
        <div className="flex flex-col w-full px-4 pb-6">
            <div className="flex items-center mr-3">
                <label htmlFor="" className="   font-bold">Sắp xếp theo</label>
                <div className='ml-4 relative flex items-center shadow-lg p-2 bg-white'>
                    <label className="text-[0.9rem]" htmlFor="">Theo thời gian: </label>
                    <button
                    ...
                    {
                        isClickSort && (
                            <div className="absolute top-8 right-0 z-10 mt-1 w-24 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button">
                                <ul>
