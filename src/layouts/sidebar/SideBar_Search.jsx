...
const SideBarSearch = () => {
  ...
  return (
    <div className="flex flex-col w-80 p-6 font-poppins">
      ...
      <div className="mt-4 space-y-4 p-3 min-h-[50vh] bg-yellow-500 rounded-md font-semibold">
        {/* Môn học */}
        <div className="flex flex-col">
          ...
          {selectedDropdown === "subjects" && (
            <ul className="bg-white mt-2 rounded-md p-2 space-y-2 z-10">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <i
              className={`fas fa-chevron-down transition-transform duration-2000 ${selectedDropdown === "classes" ? "transform rotate-180" : ""
                }`}
            ></i>
          </div>
        ...
        <div className="flex flex-col">
          ...
          {selectedDropdown === "students" && (
            <ul className="bg-white mt-2 rounded-md p-2 space-y-2 border-2">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <i
              className={`fas fa-chevron-down transition-transform duration-2000${selectedDropdown === "sessions" ? "transform rotate-180" : ""
                }`}
            ></i>
          </div>
